 ...
 * <ul>
 *   <li>If {@code authorizedOverdraft} is {@code null}, the created current account will have
 *   no authorized overdraft (equivalent to an overdraft limit of zero).</li>
 *   <li>If {@code authorizedOverdraft} is provided, it must be greater than or equal to zero and
 *   represents the maximum authorized overdraft for the current account.</li>
 * </ul>
 */
